...
public class IntroToArray {
	...
	public static void main(String[] args) {
		...
		/* if we wanted to keep the scores of 30 students
		...
		*/
		...
		//data type (int) ,   []--> array indicator
		// array1 --> identifier (name), new keyword datatype and size
		...
		System.out.println(array1[0]); //print the value of the element at index 0
		System.out.println(array1[1]);
		System.out.println(array1[2]);
		System.out.println(array1[3]);
		System.out.println(array1[4]);
	//	System.out.println(array1[5]); // when you try to access an index that does not
		//exist in the array, then you get ArrayIndexOutOfBoundException
